...
| Skill | Was er macht |
|---|---|
| [Priming](priming/SKILL.md) | Aktiviert Vorwissen und baut vor der ersten Informationsaufnahme ein klares Denkgerüst auf |
| [Feynman](feynman/SKILL.md) | Prüft Verständnis durch Erklären, Nachfragen, Korrigieren und erneutes Vereinfachen |
...
Kopiere die passende `SKILL.md` in dein Projekt und referenziere sie in deiner `CLAUDE.md`.

**Als System-Prompt:**

Nutze den Inhalt der `SKILL.md` direkt als System-Prompt oder als Referenz in deinem Setup.
